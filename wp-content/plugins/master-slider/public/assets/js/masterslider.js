...
; (function ($) {
	...
	p.setup = function () {
		...
		this.$backgroud = $('<div style="position: absolute;right: -50%;width:100%;top: 17px;"><div style="height: 26px;border-radius: 15px;opacity: 0.2;background-color: white;"></div></div>')
			.appendTo(this.$element);

		this.$backgroud = $('<div style="position: absolute;width: 70%;top: 29px;right: -37%;"><div style="height: 2px;background-color: #98FAFC;"></div></div>')
			.appendTo(this.$element);

		this.$bullet_prev = $('<div>Previous</div>')
			.addClass('ms-bullets-prev')
			.on('click', function () { that.slider.api.previous(true); })
			.appendTo(this.$element);
		...
		this.$bullet_next = $('<div>Next</div>')
			.addClass('ms-bullets-next')
			.on('click', function () { that.slider.api.next(true); })
			.appendTo(this.$element);
	...
	p.create = function () {
		...
		for (var i = 0; i < this.slider.api.count(); ++i) {
			var bullet = $('<div><span>' + (i + 1) + '</span></div>').addClass('ms-bullet');
			bullet[0].index = i;
		...
		if (this.options.dir === 'h') {
			this.$element.width(bullet.outerWidth(true) * this.slider.api.count() + 165);
	...
	p.unselect = function (ele) {
		...
		ele.css('margin', this.options.space * 2);
	};
